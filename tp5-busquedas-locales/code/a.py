...
class QueenGA:
    ...
    def generate_random_individual(self):
        return random.sample(range(self.n), self.n)  # Genera una lista de posiciones únicas
    ...
    def mutate(self, individual):
        if random.random() < self.mutation_rate:
            ...
            individual[i] = random.randint(0, self.n - 1)  # Asegúrate de que esto mantenga la validez
